...
public abstract class XInjector {
    protected final String clazzName, fieldName;
    protected final boolean copyValues;

    public XInjector(String clazzName, String fieldName, boolean copyValues) {
    ...
    private Field getPermissibleField(Player player) throws NoSuchFieldException {
        ...
        try {
            ...
            XUtil.severe("Unknown server implementation being used!");
            return null;
        }

        if (!humanEntity.isAssignableFrom(player.getClass())) {
        	XUtil.severe("Strange error while injecting permissible!");
            return null;
        }
    ...
    public static class ServerNamePermissibleInjector extends XInjector {
    ...
    public static class ClassPresencePermissibleInjector extends XInjector {
    ...
    public static class ClassNameRegexPermissibleInjector extends XInjector {
