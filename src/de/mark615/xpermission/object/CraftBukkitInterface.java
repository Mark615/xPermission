...
public class CraftBukkitInterface
{
	 ...
	 *
	 * @param simpleName
	 *            The name of the class without the "org.bukkit.craftbukkit"
	 *            prefix
	 * @return The versioned class name, or {@code null} if not CraftBukkit.
	 */
	public static String getCBClassName(String simpleName)
	{
		return VERSION == null ? null : CRAFTBUKKIT_PREFIX + VERSION + simpleName;
	}
    ...
    public static Class getCBClass(String name)
    {
        try
        {
            return VERSION == null ? null : Class.forName(getCBClassName(name));
        }
